...
class ProfileScreen extends StatelessWidget {
  ...
  Widget _buildRecentActivity() {
    final activities = [
      ...
      {'date': '11/10', 'action': 'Hoàn thành Quiz Common Phrases (85%)', 'type': 'quiz'},
      {'date': '10/10', 'action': 'Thêm bộ flashcard Travel Vocabulary', 'type': 'flashcard'},
      {'date': '09/10', 'action': 'Đạt thành tích 7-Day Streak', 'type': 'achievement'},
    ];
